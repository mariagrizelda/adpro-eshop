...
public class ProductController {
    ...
    public String editProductPost(@ModelAttribute Product product, Model model, @PathVariable String id) {
        // Assuming service.edit still requires a Product object
    ...
    public String deleteProduct(@PathVariable String id) {
        // Assuming service.delete now requires a Product object with the correct ID
        Product productToDelete = service.get(id);
